...
function searchImages() {
    ...
    var dest = $.net.http.readDestination("sap.hana.democontent.epm.services", "images.02"); //sap.hana.democontent.epm.services.images.02 sap.hana.democontent.epm.services.images
